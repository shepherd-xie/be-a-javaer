...
![图 8-1 一个简单的打车应用](../assets/8-1.png)
...
![图 8-2 一个单体应用分解成微服务](../assets/8-2.png)
...
![图 8-3 开发和交付中的伸缩立方（Scale Cube）](../assets/8-3.png)
...
![图 8-4 使用 Docker 部署 Trip Management 服务](../assets/8-4.png)
...
![图 8-5 打车应用的数据库架构](../assets/8-5.png)
